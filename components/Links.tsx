const Links = () => {
  return (
    <div className="flex flex-col mb-4">
      <div className="flex flex-wrap gap-2 my-1 text-xl text-center">
        <a
          className="gap-2 btn"
      ...
      <div className="flex flex-wrap gap-2 my-1 text-xl text-center">
        ...
        <a
          className="gap-2 btn"
          href="https://twitter.com/codercatdev"
          rel="noreferrer"
          target="_blank"
        >
          <svg
      ...
      <div className="flex flex-wrap gap-2 my-1 text-xl text-center">
        <a
          className="gap-2 btn"
          href="https://developers.google.com/community/experts/directory/profile/profile-alex-patterson"
          rel="noreferrer"
          target="_blank"
        >
          <svg
